...
return<>
  ...
  <img  src={`https://image.tmdb.org/t/p/original${backdrop_path ||poster_path}`}  alt={title ||name} className="w-full relative h-[400px] lg:h-[400px] object-cover rounded-tl-[50px]"
  />

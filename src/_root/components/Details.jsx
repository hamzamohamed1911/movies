  ...
  return (
    <div className="relative pt-20">
      <img
        ...
        alt={item.title}
        className="w-full lg:h-[600px] h-[400px] object-cover rounded-tl-[50px] p-4"
      />
      <div className="absolute inset-0 p-4 lg:p-24 bg-gradient-to-b from-transparent to-slate-950 flex flex-col justify-center items-center sm:items-start text-white rounded-lg shadow-lg">
        <div className="flex flex-col sm:flex-row items-center sm:items-start lg:space-y-6 space-y-4 sm:space-x-10">
          <img
            src={`https://image.tmdb.org/t/p/w400${item.poster_path}`}
            alt={item.title}
            className="w-52 h-72 lg:w-[320px] lg:h-[460px] object-fill rounded-lg shadow-md"
          />
          <div className="text-center sm:text-left max-w-full sm:max-w-md lg:max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-4 justify-center sm:justify-start">
